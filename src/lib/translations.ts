...
export const RECIPE_UI: Record<string, Record<Locale, string>> = {
  ...
  'fromOurGuides': { en: 'From Our Guides', fr: 'Nos guides', es: 'De nuestras guías', de: 'Aus unseren Ratgebern', pt: 'Dos nossos guias' },
  'affiliateDisclosure': {
  ...
  'changeLanguage': { en: 'Change language', fr: 'Changer de langue', es: 'Cambiar idioma', de: 'Sprache ändern', pt: 'Mudar idioma' },
  ...
  'cookModePrev': { en: 'Previous', fr: 'Précédent', es: 'Anterior', de: 'Zurück', pt: 'Anterior' },
  'cookModeDone': { en: 'Done', fr: 'Terminé', es: 'Listo', de: 'Fertig', pt: 'Concluído' },
  ...
  'italianIceNoticeTitle': { en: 'Italian Ice Program — Deluxe Models Only', fr: 'Programme Glace Italienne — Modèles Deluxe Uniquement', es: 'Programa de Helado Italiano — Solo Modelos Deluxe', de: 'Italian-Ice-Programm — Nur Deluxe-Modelle', pt: 'Programa Italian Ice — Apenas Modelos Deluxe' },
  'italianIceNoticeDesc': { en: 'This recipe uses the Italian Ice program, available only on the Ninja CREAMi Deluxe (NC501) and XL Deluxe 11-in-1. If your model does not have Italian Ice, use the Sorbet setting for a similar result. The texture will be slightly smoother than traditional Italian ice, but still delicious.', fr: 'Cette recette utilise le programme Italian Ice, disponible uniquement sur le Ninja CREAMi Deluxe (NC501) et XL Deluxe 11-in-1. Si votre modèle ne dispose pas de ce programme, utilisez le réglage Sorbet pour un résultat similaire. La texture sera légèrement plus lisse que la glace italienne traditionnelle, mais tout aussi délicieuse.', es: 'Esta receta utiliza el programa Italian Ice, disponible solo en el Ninja CREAMi Deluxe (NC501) y XL Deluxe 11-in-1. Si su modelo no tiene Italian Ice, use el modo Sorbete para un resultado similar. La textura será ligeramente más suave que el helado italiano tradicional, pero igualmente delicioso.', de: 'Dieses Rezept nutzt das Italian-Ice-Programm, das nur auf dem Ninja CREAMi Deluxe (NC501) und XL Deluxe 11-in-1 verfügbar ist. Wenn Ihr Modell kein Italian Ice hat, verwenden Sie die Sorbet-Einstellung für ein ähnliches Ergebnis. Die Textur wird etwas glatter als traditionelles Italian Ice sein, aber dennoch köstlich.', pt: 'Esta receita utiliza o programa Italian Ice, disponível apenas no Ninja CREAMi Deluxe (NC501) e XL Deluxe 11-in-1. Se seu modelo não tem Italian Ice, use o modo Sorbet para um resultado similar. A textura será ligeiramente mais suave que o Italian Ice tradicional, mas igualmente delicioso.' },
